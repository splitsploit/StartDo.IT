                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12">
                            <div class="table-pricing paket-gila">
                                ...
                                <p>
                                    <a href="{{ route('checkout.create', 'intermediate-class') }}" class="btn btn-master btn-primary w-100 mt-3">
                                        Take This Plan
                                    </a>
                                </p>
                            </div>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="table-pricing paket-biasa">
                                ...
                                <p>
                                    <a href="{{ route('checkout.create', 'beginner-class') }}" class="btn btn-master btn-secondary w-100 mt-3">
                ...
                <div class="col-lg-10 col-12">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="item-review">
                                ...
                                <div class="user">
                                    <img src="{{ asset('assets/images/byyyy.jpg') }}" class="photo" alt="">
                                    <div class="info">
                                        <h4 class="name">
                                            Siska
                                        </h4>
                    ...
                    <div class="row copyright">
                        <div class="col-lg-12 col-12">
                            <p>
                                All Rights Reserved. Copyright StartDo.IT | JogjaXploit Network.
                            </p>
                        </div>
                    </div>
                </div>
