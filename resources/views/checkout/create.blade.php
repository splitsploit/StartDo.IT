                        ...
                        <div class="col-lg-6 col-12">
                            <form action="{{ route('checkout.store', $camp->id) }}" class="basic-form" method="POST">
                                ...
                                <div class="mb-5">
                                    <div class="row">
                                        <div class="col-lg-6 col-12">
                                            ...
                                            <input name="expired" type="month" class="form-control {{ $errors->has('expired') ? 'is-invalid' : '' }}" />
                                        ...
                                        <div class="col-lg-6 col-12">
                                            ...
                                            <input name="cvc" type="number" class="form-control {{ $errors->has('cvc') ? 'is-invalid' : '' }}" maxlength="3" />
                                            @if ($errors->has('cvc'))
                                ...
                                <div class="mb-4">
                                    ...
                                    <input name="discount" type="text" class="form-control {{ $errors->has('discount') ? 'is-invalid' : '' }}" value="{{ Auth::user()->discount }}" />
